...
def handle_sell_stock(message):
    ...
    bot.send_message(message.chat.id,
        ...
        f"<tg-emoji emoji-id=\"5217871612321216821\">💰</tg-emoji> Цена продажи: {format_balance(sell_price)}/шт.\n"
...
MINE_RENT_DURATION = 6 * 60 * 60  # 12 часов
...
PICKAXE_LEVELS = {
    1: {"stars": 0,  "bonus": 1.0, "cooldown": 11*60, "label": "Деревянная", "emoji_id": 6278551946852831281, "rare_boost": 0.0, "res_qty": 1},
    2: {"stars": 10, "bonus": 1.3, "cooldown": 5*60,  "label": "Каменная",   "emoji_id": 6280609481000750585, "rare_boost": 0.0, "res_qty": 1},
    3: {"stars": 20, "bonus": 1.6, "cooldown": 4*60,  "label": "Железная",   "emoji_id": 6280750854144266316, "rare_boost": 0.1, "res_qty": 2},
    4: {"stars": 40, "bonus": 1.8, "cooldown": 3*60,  "label": "Золотая",    "emoji_id": 6278187557532472415, "rare_boost": 0.2, "res_qty": 2},
    5: {"stars": 80, "bonus": 2.0, "cooldown": 150,    "label": "Алмазная",   "emoji_id": 6280722322676519252, "rare_boost": 0.3, "res_qty": 3},
    6: {"stars": 160, "bonus": 2.3, "cooldown": 60,   "label": "Незеритовая", "emoji_id": 6280318969412849349, "rare_boost": 0.9, "res_qty": 4, "multi_res": True},
}
PICKAXE_MAX = 6
