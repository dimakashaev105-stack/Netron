...
def handle_buy(message):
    ...
    markup.row(
        InlineKeyboardButton("💵 75k за 15 звезд", callback_data="stars_75kkk"),
        InlineKeyboardButton("💵 120k за 25 звезд", callback_data="stars_100kkk")
    )
    markup.row(
        InlineKeyboardButton("💵 500k за 100 звезд", callback_data="stars_500kkk")
    )
...
def handle_stars_selection(call):
    ...
    packages = {
        ...
        "stars_75kkk": {"amount": 75000, "stars": 15, "title": "75k"},
        "stars_100kkk": {"amount": 120000, "stars": 25, "title": "120k"},
        "stars_500kkk": {"amount": 500000, "stars": 100, "title": "500k"}
    }
