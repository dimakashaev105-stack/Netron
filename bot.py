...
def handle_pvp_menu(message):
    ...
    kb = {"inline_keyboard": [
        ...
        [{"text": "🏟 Arena  · скоро", "callback_data": "pvp_menu_arena"}],
    ]}
...
@bot.callback_query_handler(func=lambda c: c.data == "pvp_menu_arena")
def cb_pvp_menu_arena(call):
    bot.answer_callback_query(call.id, "🏟 Arena — в следующем обновлении!", show_alert=True)
