...
👤 ПРОФИЛЬ И БАЛАНС:
• профиль / /profile — твой профиль, уровень, статистика
• баланс — показать баланс (или "балан [ник]" — баланс другого)
• имя [новое имя] — сменить отображаемое имя
• меню — главное меню

💰 ЭКОНОМИКА:
• перевести [сумма] [ник/@юзер] — перевод (10% комиссия)
• чек [сумма] / /чек — создать чек на сумму
• промо [код] / /promo [код] — активировать промокод

🏦 БАНК И ВКЛАДЫ:
• вклад [сумма] [часы] — открыть срочный вклад
• вклад инфо — инфо по текущему вкладу
• вклад получить — забрать вклад досрочно

💳 КРЕДИТЫ:
• чеф [сумма] — взять кредит (макс 100к, 10%, до 3 дней)

🎰 ИГРЫ (все принимают ставку числом или "всё/макс"):
• слоты [ставка] — игровые автоматы
• рулетка [ставка] [цвет/число] / рул [ставка] — рулетка
• монетка [ставка] [орёл/решка] — подбросить монету
• краш [ставка] — множитель растёт, нажми стоп вовремя
• кости [ставка] — кубики против бота
• блэкджек [ставка] — 21
• хайкард [ставка] — у кого карта старше
• дартс [ставка] — дартс
• кнб [ставка] — камень-ножницы-бумага
• мины [ставка] — минное поле
• дуэль [ставка] [ник/@юзер] — вызов игрока на дуэль

📈 АКЦИИ:
• купить акции [кол-во] — купить акции FECTZ
• продать акции [кол-во] — продать акции FECTZ
• история акций — история цен и твои сделки

⛏️ МАЙНИНГ:
• майнинг — меню майнинга
• купить карту — купить видеокарту
• майнить — собрать намайненное

🚗 ТАКСИ:
• такси — начать работу таксистом

👗 МАГАЗИН И ОДЕЖДА:
• магазин — магазин одежды
• гардероб / вещи — твои вещи
• обмен [ник] [вещь] — обменять вещь с игроком
...
👑 ПРЕМИУМ:
• /premium — купить премиум подписку (даёт доступ к ИИ + бонус к вкладам)

💳 ДОНАТ:
• /buy / донат — купить 🌸 за звёзды Telegram (~26к за 1 звезду)

🎟️ ЛОТЕРЕЯ И АУКЦИОН:
• лот [цена] — выставить вещь на аукцион

🤖 ИИ ПОМОЩНИК (только Premium):
• гугл [вопрос] — задать вопрос ИИ

НАЛОГИ (собирает только админ): >1млн=10%, >100к=5%, остальные=3%

ВАЖНО: не предлагай команды которых нет в этом списке. Если не знаешь команду — скажи что такой нет.
